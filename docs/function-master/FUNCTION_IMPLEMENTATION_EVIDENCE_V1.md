...
| P3-INV movement/event | main `7e50a04df6dcc8043689958cbfd9be42e15e1af7` | `CHANGES_REQUIRED` | fixed mainのMovement/Event経路を静的監査 | Movement commit後のDomainEvent失敗retryでMovement重複0、異操作誤dedupe0、Movement/Audit/EventまたはOutbox 1:1 lineageが未証明。Codex CR #4978770056 |
| P3-CRM Lead Convert | main `7e50a04df6dcc8043689958cbfd9be42e15e1af7` | `CHANGES_REQUIRED` | `convertLeadToCustomerAction`のblob `132c43b6c0aed84868a67e136b75661d04da6778`がPR #49 fixed headとmainで一致することを確認 | AI主体の実Customer/Deal確定を人間Auditとして誤記録するHigh、既存linkのtenant/整合性、真の並行barrier/fault rollback証拠が未解消。Codex CR #4964622641 |
| P3-Meeting classification | main `7e50a04df6dcc8043689958cbfd9be42e15e1af7` | `CHANGES_REQUIRED` | UIの6種別と保存label/ABAC経路を固定mainで静的監査 | Server Actionのtype allowlistがなく、未知値/typoが`INTERNAL`へfail-openする。provider前検証とMeeting/Knowledge label一貫性が未証明。Codex CR #4978992477 |
