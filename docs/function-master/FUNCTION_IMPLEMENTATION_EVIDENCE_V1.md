...
## 2026-07-15 Gate-0後の固定Evidence snapshot
...
| P3-FIN-1 / PR #57 | `aca8b6b4262ebaccf723fc72fe4a8a01ef665756` | `CI_VERIFIED` / `CHANGES_REQUIRED` | Payment/VOIDのlock後status再読込 | request-level idempotency、同額別支払、post-commit副次処理retry、孤児0が未証明。Codex CR #4969823555 |
...
- Phase 3 defect/Gate Matrix: `docs/coordination/codex/V87_PHASE3_DEFECT_AND_GATE_MATRIX.md`
- Sync Manifest: `docs/coordination/codex/V87_SYNC_MANIFEST.md`
