...
| C22紹介候補分析/Fake下書きpreview | `UNMAPPED_CANDIDATE / EVIDENCE_GAP` | PR #23 `9209ef856523ae2e10a303849dc13a088e1f426c`、unit 11/11、Codex comments `4951991026`、`4952108925` | read-only Draftは存在。顧客名の取得段階遮断、detail link、別tenant実在ID、一覧DataAccessLog、exact-head CIが不足。C22正式IDへ推測格上げしない |
...
| P3-R01 release regression hardening | `UNMAPPED_CANDIDATE / CODEX_VERIFIED` | PR #18 `d209d5da35fc24ac0c101145126d55850c001f93`、CI `29202591101` unit 472/E2E 151、artifact `8262874173`、Codex pass `4952187587` | PR #27のtopbar/回帰test伝播とC21同一URL race修正の限定PASS。44反復はClaude local evidence。後継RC、同一SHA Human Preview、main、Productionは未確認 |
