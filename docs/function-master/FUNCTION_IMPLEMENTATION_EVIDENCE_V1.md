...
| C19 schema案A 承認ブリッジ | `UNMAPPED_CANDIDATE` | Human Gate comment `4951063085`でDraft実装・使い捨て/CI DB検証までGO | remote固定head/実装/CIは未受領。本番migration、外部広告変更、予算変更、実LLMは未承認。正式IDを創作しない |
