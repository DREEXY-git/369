...
|---|---|---|
| #18 | `524t4uqsjvvxvEctqHhjiDQrustv` | exact headのbuild badge、mobile theme、C21承認、主要NAVを確認要 |
| #22 | `HAH5shAjcQdkWbDH34Cw2kPvWnDm` | P2修正後に再確認。現headはHOLD |
| #20 | `E3G6NrQpgdvytuSsFwHwfuV4of3i` | stale、再確認、approve後QUEUEDを確認要 |

C22 Referral、安全なAI Inbox、Execution Receipt、Workflow Dry Run、回帰自動化、競合fit-gapの新しいClaude固定headはScout時点で存在しなかった。存在しない実装を完成扱いせず、すべて`WAITING_FOR_CLAUDE_HEAD / ROADMAP_ONLY`とする。
