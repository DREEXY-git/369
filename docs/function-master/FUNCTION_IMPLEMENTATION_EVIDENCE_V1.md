...
| P3-FIN-1 / PR #57 | `71d41870ed6ff0241915534e2cd43cf43e30e1c4` | `CI_FAILED` / `CHANGES_REQUIRED` | Payment/VOIDのlock後status再読込とsame-key idempotencyテストは保持 | exact-head run `29369863839`でstage3/`release_gate` failure。異なる6並列入金が`Expected 6 / Received 1`へ誤収束。failure artifact `8325779897`。Codex CR #4978049489 |
