# QA-EVID-01 — Evidence Reviewer Chat Prompt
...
同一fixed SHAでacceptance、test collection、skip、exact-head CI、artifactを独立判定する。
...
- target branch write禁止
- Security verdictのコピー禁止

## Preliminary blind verdict
